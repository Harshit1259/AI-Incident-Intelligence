...
echo ""
echo -e "  ${BOLD}Test a webhook (no tool needed):${NC}"
echo -e "    curl -s -X POST http://localhost:8080/api/v1/ingest/webhook \\"
echo -e "      -H 'Content-Type: application/json' \\"
echo -e "      -d '{\"source\":\"test\",\"service\":\"api\",\"severity\":\"critical\",\"title\":\"High error rate\"}'"
echo ""
